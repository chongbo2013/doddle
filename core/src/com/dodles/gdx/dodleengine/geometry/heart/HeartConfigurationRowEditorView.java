...
/**
 * Heart configuration row.
 */
@PerDodleEngine
public class HeartConfigurationRowEditorView extends AbstractEditorView {
    ...
    @Inject
    public HeartConfigurationRowEditorView(AssetProvider assetProvider, GeometryRegistry geometryRegistry, GeometryTool geometryTool) {
