...
/**
 * Triangle configuration row.
 */
@PerDodleEngine
public class TriangleConfigurationRowEditorView extends AbstractEditorView {
    ...
    @Inject
    public TriangleConfigurationRowEditorView(AssetProvider assetProvider, GeometryRegistry geometryRegistry, GeometryTool geometryTool) {
    ...
    public final void activate(Skin skin, String newState) {
        ...
        updateRadius(radiusLabel, radiusSlider, ((AbstractPolygonGeometryConfig) geometryRegistry.getGeometryConfig()).getCornerRadius());
    }
    ...
    private void updateRadius(Label label, Slider slider, float value) {
        ...
        label.setText(intString);
        slider.setValue(intValue);
        ((AbstractPolygonGeometryConfig) geometryRegistry.getGeometryConfig()).setCornerRadius(value);
        geometryTool.regenerateShape();
    }
}
