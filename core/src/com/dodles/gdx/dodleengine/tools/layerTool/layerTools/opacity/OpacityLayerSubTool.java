...
/**
 * The "Opacity" layer tool handles setting the opacity of the selected objects.
 */
@PerDodleEngine
public class OpacityLayerSubTool extends AbstractLayerSubTool implements LayerSubTool {
    public static final String TOOL_NAME = LayerTool.TOOL_NAME + ".Opacity";
    public static final String ACTIVATED_COLOR = "tray-background";
    private final ObjectManager objectManager;

    @Inject
    public OpacityLayerSubTool(AssetProvider assetProvider, FullEditorViewState fullViewState, LayerSubToolRegistry layerSubToolRegistry, ObjectManager objectManager, OpacityLayerSubToolFullEditorOverlay overlay) {
        super(assetProvider);
    ...
    public final TextureRegion getIcon() {
        return new TextureRegion(getToolBarIconsTexture(), 50, 2, 44, 44);
    }
