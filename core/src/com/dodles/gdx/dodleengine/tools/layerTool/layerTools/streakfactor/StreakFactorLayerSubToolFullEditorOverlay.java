...
/**
 * Overlay that manages stroke streak factor.
 */
public class StreakFactorLayerSubToolFullEditorOverlay extends BaseSliderOverlay {
    private static final String PROPERTY_NAME = "streakfactor";

    @Inject
    public StreakFactorLayerSubToolFullEditorOverlay(AssetProvider assetProvider, ToolRegistry toolRegistry, OkCancelStackManager okCancelStack, ObjectManager objectManager, CommandFactory commandFactory, CommandManager commandManager) {
