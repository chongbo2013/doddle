...
public class Paint implements Poolable {
	...
	final Vector2 gradientPoint1 = new Vector2();
	final Vector2 gradientPoint2 = new Vector2();
	final AffineTransform gradientTransform = AffineTransform.obtain();

	public static Paint obtain() {
		return FastPools.obtainPaint();
	}
	...
	public Paint setToImage(float left, float top, float width, float height, float angleDegrees, float alpha, Image image) {
		return setToImageRad(left, top, width, height, MathUtils.degreesToRadians * angleDegrees, alpha, image);
	}
	...
	public Paint setImage(float left, float top, float width, float height, float angleDegrees, float alpha, Image image) {
		return setImageRad(left, top, width, height, MathUtils.degreesToRadians * angleDegrees, alpha, image);
	}
	...
	public boolean equals(Object obj) {
		...
		if (!solidColor.equals(other.solidColor)) {
			return false;
		}
		return true;
	}
	...
	public int hashCode() {
		...
		result = prime * result + NumberUtils.floatToIntBits(gradientRadius);
